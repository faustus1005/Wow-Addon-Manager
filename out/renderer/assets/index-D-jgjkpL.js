      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 no-drag shrink-0", onClick: (e2) => e2.stopPropagation(), children: [
            addon.updateAvailable && !addon.isIgnored && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-success text-xs py-1 px-3", onClick: handleUpdate, children: "Update" }),
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-gray-800 space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AutoUpdateToggle, { addon }),
...
function Browse() {
  ...
  const PAGE_SIZE = 20;
  const inputRef = reactExports.useRef(null);
  const doSearch = reactExports.useCallback(async (newQuery, newPage, append = false) => {
    setLoading(true);
    try {
      const res = await window.api.searchAddons({
        query: newQuery,
        provider: provider === "all" ? void 0 : provider,
        flavor,
        page: newPage,
        pageSize: PAGE_SIZE
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full page-enter", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 border-b border-gray-800 shrink-0 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-gray-200", children: "Browse Addons" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSearch, className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn-primary px-5", disabled: loading, children: loading ? "⟳" : "🔍 Search" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-5 py-3 space-y-2", children: loading && results.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { message: "Searching…" }) }) : results.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: "🔍",
